...
public enum ResultEnum  {
    ...
    PRODUCT_NOT_EXIST(10, "Animal does not exit!"),
    PRODUCT_NOT_ENOUGH(11, "Not enough animals in stock!"),
    PRODUCT_STATUS_ERROR(12, "Status is incorrect!"),
    PRODUCT_OFF_SALE(13,"Animal is off sale!"),
    PRODUCT_NOT_IN_CART(14,"Animal is not in the cart!"),
